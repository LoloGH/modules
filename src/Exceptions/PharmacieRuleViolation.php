...
namespace Keneya\Pharmacie\Exceptions;
...
/**
 * Une règle métier de la pharmacie est violée (session fermée, montant nul,
 ...
 * d'erreurs.
 */
final class PharmacieRuleViolation extends DomainException
{
    public function render(Request $request): RedirectResponse|JsonResponse
    {
        ...
        return redirect()->back()->withInput()->with('pharmacie_error', $this->getMessage());
    }
