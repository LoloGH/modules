 ...
 *  - l'administrateur reçoit toujours toutes les permissions Finance ;
...
{
    protected $signature = 'finance:sync-permissions';

    protected $description = 'Crée les permissions et rôles du module Finance (idempotent, sans seeder)';
