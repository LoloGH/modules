...
namespace Keneya\FinanceCaisse\Tests;
...
use Keneya\FinanceCaisse\FinanceServiceProvider;
...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function defineEnvironment($app): void
    {
        ...
        $config->set('finance.standalone.enabled', false);
    }
    ...
    {
        Gate::define('finance.access', static fn () => $granted);
    }
